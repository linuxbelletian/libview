 ...
 * The CurlPageView using OpenGL ES
 */

public class CurlPageView extends GLSurfaceView
    ...
    // Page meshed. Left and right meshes are 'static' while curl is used to
    // show page flipping.
    ...
    public CurlPageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

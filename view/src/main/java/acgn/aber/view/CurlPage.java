...
public class CurlPage {
    ...
    /**
     * Generates nearest power of two sized Bitmap for give Bitmap.
     * Returns this new Bitmap using default return statement + orginal
     * texture coordinates are stored into RectF.
     *
     * */
    private Bitmap getTexture(Bitmap bitmap, RectF textureRect) {
        ...
        // Bitmap size expanded to next power of two. This is done
        // due to requirement on many devices, texture width and height
    ...
    /**
     * Getter for textures. Creates Bitmap sized to nearst power of two, copies
